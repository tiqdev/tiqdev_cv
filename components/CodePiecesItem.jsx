  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-[12px] md:max-w-[40%] max-w-full">
        ...
        <h2 className="text-[20px] font-[500] text-[#D8D8D8] leading-[28px] -tracking-[0.02em]">
          {code.title}
        </h2>
        <div className="flex flex-row items-center justify-start gap-[8px]">
        <svg
          className="w-[24px] h-[24px] flex md:hidden fill-grey group-hover:fill-secondary transition-all duration-500"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 256 256"
          focusable="false"
        >
