const TestimonialItem = ({ name, role, image, text }) => {
  return (
    <div className="md:max-w-[520px] w-full border-t-[1px] border-solid border-badge bg-badge flex flex-col space-y-[32px] items-start justisfy-start p-[32px] rounded-[24px] font-inter">
      <h2 className="text-[24px] font-[400] text-white leading-[32px] -tracking-[0.02em]">
        {text}
      </h2>
